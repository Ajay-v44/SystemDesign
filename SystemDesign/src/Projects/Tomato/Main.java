package Projects.Tomato;

import Projects.Tomato.Models.*;
import Projects.Tomato.Strategies.UpiPaymentStrategy;
...
public class Main {
    static void main() {
        ...
        User user = new User(1904, "Ajay", "Chennai");
        System.out.println("User: " + user.getName() + " is active.");

        // User searches for restaurants by location
        java.util.List<Restaurant> restaurantList = tomato.searchRestaurants("Chennai");
